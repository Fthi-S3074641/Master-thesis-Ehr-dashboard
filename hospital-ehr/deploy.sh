...
composer network install -c PeerAdmin@hlfv1 -a hospital-ehr@0.0.1.bna 

composer network start  -c PeerAdmin@hlfv1 -n hospital-ehr -V 0.0.1 -A admin -S adminpw -f networkadmin.card
